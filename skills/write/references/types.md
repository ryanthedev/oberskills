...
| **Marketing** | Decide to *act* (buy, click, sign up) — fast | Benefit first. Specificity beats superlative. One emotional hook tied to one concrete proof point. This row is the summary; the craft (reader awareness, proof, the claims rider) is in `references/copy.md`. | Buzzword density ("unlock," "seamless," "game-changer") — vague superlatives, zero specifics. |
